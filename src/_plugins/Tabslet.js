	...
	($.fn.tabslet = function (options) {
		...
		return this.each(function () {
			...
			var $this = $(this),
				...
				_tabs = _container.find("> .tabslet-content, .tabslet-content, [data-product-new], .product-count");
			_tabs.each(function () {
				_cache_div.push($(this).css("display"));
			});
			var elements = $this.find("ul.tabslet-tab > li, .zone-product-item-mobile h2"),
				i = options.active - 1;
