	...
	<xsl:template match="/">
		<div class="receive-address clearfix">
			<section class="cart-form clearfix">
				...
				<div class="wrap-form">
					<div class="group clearfix">
						...
						<section class="form-group">
							...
							<div class="input phone">
								...
								<!-- <div class="des">
									...
									<xsl:text>(</xsl:text>
									<xsl:value-of select="/CheckoutAddress/DeliveryStaffWillContactWithThisPhoneNumberText"></xsl:value-of>
									<xsl:text>.)</xsl:text>
								</div> -->
							</div>
						</section>
						<section class="form-group">
							<div class="label">
								...
								<!-- <div class="des" style="margin-left: 5px">
									<xsl:text>   (không bắt buộc)</xsl:text>
								</div> -->
							</div>
							<div class="input">
						...
						<section class="form-group">
							...
							<div class="input">
								<input type="text" name="Address_Address">
									<xsl:attribute name="placeholder">
										<xsl:value-of select="/CheckoutAddress/Ex64HiepBinhStreetText"></xsl:value-of>
									</xsl:attribute>
									<xsl:attribute name="value">
						...
						<section class="form-group">
							<div class="label">
								<label>
									...
									<!-- <div class="des">
										<xsl:text>(</xsl:text>
										<xsl:value-of select="/CheckoutAddress/OptionalText"></xsl:value-of>
										<xsl:text>)</xsl:text>
									</div> -->
								</label>
							</div>
							<div class="input">
								<textarea name="OrderNote" cols="30" rows="2">
									<xsl:attribute name="placeholder">
										<xsl:value-of select="/CheckoutAddress/ExDeliveryOutOfOfficeHoursText"></xsl:value-of>
									</xsl:attribute>
									<xsl:value-of select="/CheckoutAddress/OrderNote"></xsl:value-of>
								</textarea>
								<div class="des">
									<xsl:text>Vui lòng ghi rõ thông tin nếu bạn là người nước ngoài</xsl:text>
								</div>
							</div>
						</section>
					</div>
					<div class="group clearfix">
						<section class="check-group">
							...
							<label id="btn-ttmh" for="ttmh">
								<xsl:value-of select="/CheckoutAddress/ReceiverInformationWithOtherAddressText"></xsl:value-of>
							</label>
						</section>
					...
					<div class="title bill-title-check">
		...
		<div class="export-bill clearfix">
			<section class="cart-form bill-form clearfix">
				<h2 class="carttitle">Xuất hóa đơn đỏ</h2>
