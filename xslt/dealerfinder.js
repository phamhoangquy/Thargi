                        ...
                        if (results.length > 0) {
                            ...
                            jQuery.each(results, function(k, v) {
                                ...
                                if (v.getAttribute("email") != "") {
                                    phoneFax += "<div><span>" + v.getAttribute("email") + "</div>";
                                }
								
                                if (number > 9) {
                                    $("<li id='l_" + marker['__gm_id'] + "' class='clinic_list double-digit'" + "data-iframe='"+v.getAttribute("des")+"' />")
                                        .html('<p class="name"><strong>' + v.getAttribute("name") + '</strong></p><p class="address"><span>Địa chỉ:' + v.getAttribute("address") + '</span></p><p class="phone"><span>Tel: <a href="tel: '+v.getAttribute("phone")+'">'+v.getAttribute("phone")+'</a></span><span> - Fax: <a href="tel: '+v.getAttribute("fax")+'">'+v.getAttribute("fax")+'</a></span></p><p><span>Email: ' + v.getAttribute("email") + '</span></p>')
                                        .click(function() {
                                    ...
                                    $("<li id='l_" + marker['__gm_id'] + "' class='clinic_list'" + "data-iframe='"+v.getAttribute("des")+"' />")
										.html('<p class="name"><strong>' + v.getAttribute("name") + '</strong></p><p class="address"><span>Địa chỉ:' + v.getAttribute("address") + '</span></p><p class="phone"><span>Tel: <a href="tel: '+v.getAttribute("phone")+'">'+v.getAttribute("phone")+'</a></span><span> - Fax: <a href="tel: '+v.getAttribute("fax")+'">'+v.getAttribute("fax")+'</a></span></p><p><span>Email: ' + v.getAttribute("email") + '</span></p>')
                                        .click(function() {
                                            //displayPoint(marker, i);
                                            infowindow.setContent(info_window_string);
        ...
        success: function(msg) {
            ...
            if (results.length > 0) {
                ...
                jQuery.each(results, function(k, v) {
					...
					if (v.getAttribute("email") != "") {
                        phoneFax += "<div> " + v.getAttribute("email") + "</div>";
                    }
                    if (number > 9) {
                        $("<li id='l_" + marker['__gm_id'] + "' class='clinic_list double-digit'" + "data-iframe='"+v.getAttribute("des")+"'/>")
                            .html('<p class="name"><strong>' + v.getAttribute("name") + '</strong></p><p class="address"><span>Địa chỉ: ' + v.getAttribute("address") + '<span></p><p class="phone"><span>Tel: <a href="tel: '+v.getAttribute("phone")+'">'+v.getAttribute("phone")+'</a><span><span> - Fax: <a href="tel: '+v.getAttribute("phone")+'">'+v.getAttribute("phone")+'</a><span></p><p><span>Email: ' + v.getAttribute("email") + '</span></p>')
                            .click(function() {
                                //displayPoint(marker, i);
                                infowindow.setContent(info_window_string);
                                infowindow.open(map, marker);
