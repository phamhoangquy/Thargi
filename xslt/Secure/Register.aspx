                                                    ...
                                                    <div class="form-horizontal">
                                                        ...
                                                        <asp:Panel ID="pnlUserName" runat="server" CssClass="form-group clearfix">
                                                            ...
                                                            <div class="settingcontrol">
                                                                <asp:TextBox ID="UserName" runat="server" TabIndex="10" MaxLength="50" CssClass="form-control" placeholder="<%$Resources:HtmlResources, ImportPhoneText %>"/>
														...
														<p><asp:Literal runat="server" Text="<%$Resources:HtmlResources, AgreeingText %>"/></p>
